...
// Candidate relationships only. Tokens and control interiors belong to the package.
const relation = defineRecipe({
  className: 'atlas3-relation',
  ...
  compoundVariants: [
    // Exact midpoints, kept local to this candidate study (no new shared tokens).
...
export default defineConfig({
  ...
  theme: { extend: { recipes: { relation } } },
  staticCss: { recipes: { relation: ['*'] } },
});

...
// Keep notifications on the same Sonner instance as the library's Toaster.
export { toast } from "sonner";
import { surface, foundation, typography, card, button } from "../styled-system/recipes/index.mjs";
...
export const Surface = forwardRef<HTMLElement, HTMLAttributes<HTMLElement> & { as?: "div" | "main" | "aside" | "section"; layer?: "ground" | "chrome" | "elevated" | "elevated-2" | "top"; texture?: "auto" | "plain" | "graph" | "glass" }>(function Surface({ as: Tag = "div", layer = "ground", texture = "auto", className, ...props }, ref) {
  return <Tag {...props} ref={ref as React.Ref<HTMLDivElement>} data-surface={layer} data-texture={texture} className={cx(surface({ layer, texture }), className)} />;
});

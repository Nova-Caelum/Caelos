    ...
    <RadixDialog.Portal>
      ...
      <RadixDialog.Content ref={contentRef} {...themeAttributes(settings)}
        ...
        <div className={styles.header}>
          ...
          {actions}
          {/* A focused Close tooltip would consume Escape before the dialog can dismiss. */}
          <RadixDialog.Close asChild><IconButton variant="text" label={closeLabel} tooltip={false} icon={<X size={15} />} /></RadixDialog.Close>
        </div>

...
export const typography = defineRecipe({
  ...
  variants: {
    role: {
      ...
      mono: { fontFamily: "var(--font-nova-mono, 'IBM Plex Mono'), monospace", fontSize: "10px", lineHeight: "16px", fontWeight: 400 },
      display: { fontFamily: "var(--font-nova-heading, 'Yrsa'), serif", fontSize: "34px", lineHeight: 1.12, fontWeight: 400, letterSpacing: 0, wordSpacing: "normal" },
      page: { fontSize: "30px", lineHeight: 1.12, fontWeight: 600, letterSpacing: "-.028em" },
      section: { fontFamily: "var(--font-nova-heading, 'Yrsa'), serif", fontSize: "27px", lineHeight: 1.15, fontWeight: 400, letterSpacing: 0, wordSpacing: "normal" },

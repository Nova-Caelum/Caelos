...
Creator Note: This is an actively developing project, built specifically for one personal system and not tailored for wider use. Feedback is genuinely welcome — email daniel@novacaelum.com. External contributions are not open during pre-alpha; see [Contributing](#contributing) for why, and the [License](#license) for what the source tree does and does not grant today.
